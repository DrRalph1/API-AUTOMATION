...
import com.usg.autoAPIGenerator.dtos.collections.HeaderDTO;
import com.usg.autoAPIGenerator.entities.postgres.collections.HeaderEntity;
...
public interface HeaderRepository extends JpaRepository<HeaderEntity, String> {
    ...
    @Query("SELECT new com.usg.autoAPIGenerator.dtos.collections.HeaderDTO(" +
