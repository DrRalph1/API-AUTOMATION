    ...
    public Object execute(GeneratedApiEntity api, ApiSourceObjectDTO sourceObject,
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : dbParams.entrySet()) {
                ...
                // Also include common pagination and field selection parameters
                if (isConfigured || "page".equalsIgnoreCase(key) || "pagesize".equalsIgnoreCase(key) ||
                        ...
                        "where_condition".equalsIgnoreCase(key) || "fields".equalsIgnoreCase(key)) {
        ...
        // Add field selection support - pass fields parameter to TableExecutorUtil
        if (request.getQueryParams() != null && request.getQueryParams().containsKey("fields")) {
            dbParams.put("fields", request.getQueryParams().get("fields"));
            log.info("Added fields parameter for field selection: {}", request.getQueryParams().get("fields"));
        }
