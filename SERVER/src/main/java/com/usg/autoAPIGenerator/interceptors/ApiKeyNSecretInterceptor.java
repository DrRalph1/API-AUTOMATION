package com.usg.autoAPIGenerator.interceptors;
...
import com.usg.autoAPIGenerator.helpers.DataMaskingHelper;
import com.usg.autoAPIGenerator.helpers.ErrorHandlingHelper;
import com.usg.autoAPIGenerator.utils.LoggerUtil;
import com.usg.autoAPIGenerator.wrappers.CachedBodyHttpServletRequest;
...
public class ApiKeyNSecretInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if ("OPTIONS".equalsIgnoreCase(request.getMethod())) {
            ...
            if (origin != null && (origin.contains("10.245.78.76:9874") ||
        ...
        // Parse body content if no query parameters
            ...
            try {
                ...
                loggerUtil.log("auto-api-generator", "Failed to parse request body: " + e.getMessage());
                requestBodyMap = new HashMap<>();
                requestBodyMap.put("rawBody", rawRequestBody);
        ...
        loggerUtil.log("auto-api-generator", "Incoming Request: x-api-key=" + maskedApiKey
    ...
    private boolean handleForbidden(
        ...
        loggerUtil.log("auto-api-generator", "Access Forbidden: " + responseMessage + " for path: " + path);
        ...
        if (activityType == null ||
            ...
            loggerUtil.log("auto-api-generator", "Forbidden access attempt to: " + resourceUrl);
        }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        // Clean up if needed
        if (ex != null) {
            loggerUtil.log("auto-api-generator", "Request completed with error: " + ex.getMessage());
        }
    }
}