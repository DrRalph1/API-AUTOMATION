...
import com.usg.autoAPIGenerator.dtos.systemActivities.jwt.CheckTokenExpiryRequestDTO;
import com.usg.autoAPIGenerator.dtos.systemActivities.jwt.RefreshTokenRequestDTO;
import com.usg.autoAPIGenerator.helpers.ApiKeyNSecretHelper;
import com.usg.autoAPIGenerator.helpers.ClientIpHelper;
import com.usg.autoAPIGenerator.services.systemActivities.JWTService;
...
public class JWTController {
    ...
    public ResponseEntity<?> refreshToken(
        ...
        if (!validAPICredentials) {
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Access Forbidden. Invalid API Key or Secret.");
        ...
        if (!validClientIP) {
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Access Forbidden. Unknown Client IP.");
        ...
        try {
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Refresh token requestEntity received");
            ...
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Refresh token processed. Status: " + serviceResponse.getStatusCode());
            ...
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Refresh token error: " + e.getMessage());
    ...
    public ResponseEntity<?> checkTokenExpiry(
        ...
        try {
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Check token expiry requestEntity received");
            ...
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Check token expiry processed. Status: " + serviceResponse.getStatusCode());
            ...
            loggerUtil.log("auto-api-generator", "RequestEntity ID: " + requestId + " - Check token expiry error: " + e.getMessage());
