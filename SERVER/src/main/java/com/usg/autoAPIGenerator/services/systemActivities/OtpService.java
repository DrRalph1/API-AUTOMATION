...
import com.usg.autoAPIGenerator.repositories.OtpRepository;
import com.usg.autoAPIGenerator.helpers.DateTimeHelper;
...
public class OtpService {
    ...
    public void sendOtp(String userId, String name, String toEmail, String otpCode) throws MessagingException {
        ...
        String htmlContent = "<p>Dear " + name + ",</p>" +
                "<p>Your OTP for the Auto API Generator login is: <strong>" + otpCode + "</strong></p>" +
...
//        UserOtpEntity savedOtp = saveOtp(userId, "000000");
        ...
        if (phoneNumber != null && !phoneNumber.isBlank()) {
            smsService.sendSms(phoneNumber,
                    "Dear " + name + ", your OTP for the Auto API Generator login is: " + otp +
...
//    try {
            ...
            if (phone != null && !phone.isBlank()) {
                smsService.sendSms(phone,
                        "Hi " + username + ", your login to the Auto API Generator was successful on " +
...
//    }
    ...
    private void sendLoginSuccessEmail(String userId, String username, String toEmail) throws MessagingException {
        ...
        String htmlContent = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<p>Dear " + username + ",</p>" +
                "<p>Your login to the Auto API Generator was successful on " + DateTimeHelper.formatDateTime(Instant.now()) + ".</p>" +
