...
public class SMSRequestHelper {
    ...
    public Map<String, Object> sendSMSRCBank(String destination, String message) {
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.submitMessageTruInfoBIBRCB",
            ...
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "SMSRequestHelper.submitMessageTruInfoBIBRCB",
    ...
    public Map<String, Object> sendSMSUNION(String destination, String message) {
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.submitMessageToInfoBib",
            ...
            if (dataFromUrl.toString().contains("Accepted")) {
                ...
                loggerUtil.log(Level.WARNING, "auto-api-generator", "SMSRequestHelper.submitMessageToInfoBib",
            ...
            saveMessagetoFile(destination + message);
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "SMSRequestHelper.submitMessageToInfoBib",
    ...
    public Map<String, Object> sendSMSSIB(String destination, String message) {
        ...
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.submitSMS4LIBERIA",
                    "Response: " + response);
            ...
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "Invalid URL format", e);
            return Map.of(
            ...
            loggerUtil.log(Level.WARNING, "auto-api-generator", "Connection timeout", e);
            return Map.of(
                    "responseCode", "failedToSendSMSToProvider",
            ...
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "Communication error", e);
            return Map.of(
                    "responseCode", "failedToSendSMSToProvider",
            ...
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "Unknown error", e);
            return Map.of(
                    "responseCode", "failedToSendSMSToProvider",
                    "message", "Failed to communicate with SMS provider"
            );
    ...
    public Map<String, Object> sendSMSSLCB(String destination, String message) {
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.submitMessageTrudiafaanServer",
            ...
            if (dataFromUrl.toString().contains("Success")) {
                ...
                loggerUtil.log(Level.WARNING, "auto-api-generator", "SMSRequestHelper.submitMessageTrudiafaanServer",
            ...
            saveMessagetoFile(destination + message);
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "SMSRequestHelper.submitMessageTrudiafaanServer",
    ...
    public Map<String, Object> sendSMSUTB(String destination, String message) {
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.sendSMSUTB",
            ...
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "SMSRequestHelper.sendSMSUTB",
                    "Error submitting message to SMS provider: " + ex.getMessage());
            loggerUtil.log(Level.SEVERE, "auto-api-generator", "SMSRequestHelper.sendSMSUTB",
                    "Exception stack trace: " + Arrays.toString(ex.getStackTrace()));
    ...
    public void saveMessagetoFile(String message) {
        try {
            ...
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.saveMessagetoFile", "Message saved to offline data file");
        } catch (IOException e) {
            // System.out.println("[SMSRequestHelper] Error saving message to offline file: " + e.getMessage());
            loggerUtil.log(Level.INFO, "auto-api-generator", "SMSRequestHelper.saveMessagetoFile",
