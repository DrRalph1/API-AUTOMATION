package com.usg.apiGeneration.services.systemActivities;

import com.usg.apiGeneration.dtos.systemActivities.user.*;
import com.usg.apiGeneration.entities.postgres.UserRoleEntity;
import com.usg.apiGeneration.entities.postgres.UserEntity;
import com.usg.apiGeneration.exceptions.GlobalExceptionHandler.BusinessRuleException;
import com.usg.apiGeneration.exceptions.GlobalExceptionHandler.ConflictException;
import com.usg.apiGeneration.exceptions.GlobalExceptionHandler.ResourceNotFoundException;
import com.usg.apiGeneration.helpers.ErrorHandlingHelper;
import com.usg.apiGeneration.helpers.SortValidationHelper;
import com.usg.apiGeneration.repositories.AppRoleRepository;
import com.usg.apiGeneration.repositories.AppUserRepository;
import com.usg.apiGeneration.utils.JwtUtil;
...
public class UserService {
    ...
    public ResponseEntity<?> userLogin(UserLoginRequestDTO userLoginRequestDTO, String requestId,
        ...
        String safePerformedBy = performedBy != null ? performedBy : "UNKNOWN";
        loggerUtil.log("api-automation", "[Login] RequestEntity ID: " + requestId +
