...
import com.usg.apiGeneration.dtos.systemActivities.jwt.CheckTokenExpiryRequestDTO;
import com.usg.apiGeneration.dtos.systemActivities.jwt.RefreshTokenRequestDTO;
import com.usg.apiGeneration.helpers.ApiKeyNSecretHelper;
import com.usg.apiGeneration.helpers.ClientIpHelper;
import com.usg.apiGeneration.services.systemActivities.JWTService;
...
public class JWTController {
    ...
    public ResponseEntity<?> refreshToken(
        ...
        if (!validAPICredentials) {
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Access Forbidden. Invalid API Key or Secret.");
        ...
        if (!validClientIP) {
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Access Forbidden. Unknown Client IP.");
        ...
        try {
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Refresh token requestEntity received");
            ...
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Refresh token processed. Status: " + serviceResponse.getStatusCode());
            ...
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Refresh token error: " + e.getMessage());
    ...
    public ResponseEntity<?> checkTokenExpiry(
        ...
        try {
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Check token expiry requestEntity received");
            ...
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Check token expiry processed. Status: " + serviceResponse.getStatusCode());
            ...
            loggerUtil.log("api-automation", "RequestEntity ID: " + requestId + " - Check token expiry error: " + e.getMessage());
