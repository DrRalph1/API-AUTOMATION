...
import com.usg.apiGeneration.repositories.codeBase.CollectionRepository;
import com.usg.apiGeneration.repositories.codeBase.FolderRepository;
import com.usg.apiGeneration.repositories.codeBase.RequestRepository;
import com.usg.apiGeneration.repositories.documentation.APICollectionRepository;
import com.usg.apiGeneration.repositories.documentation.APIEndpointRepository;
...
public class ApiComponentHelper {
    ...
    public void updateCodeBase(GeneratedApiEntity api,
        ...
        try {
            ...
            if (codeBaseRequestId != null) {
                Optional<com.usg.apiGeneration.entities.postgres.codeBase.RequestEntity> existingRequest =
    ...
    public void updateCollections(GeneratedApiEntity api,
                                  ...
                                  CollectionInfoDTO collectionInfo,
                                  CollectionsGeneratorUtil collectionsGeneratorUtil,
                                  com.usg.apiGeneration.repositories.collections.CollectionRepository collectionRepository,
                                  com.usg.apiGeneration.repositories.collections.FolderRepository folderRepository,
                                  com.usg.apiGeneration.repositories.collections.RequestRepository requestRepository,
                                  EntityManager entityManager) {
        try {
            ...
            if (collectionId != null) {
                Optional<com.usg.apiGeneration.entities.postgres.collections.CollectionEntity> existingCollection =
    ...
    public void updateDocumentation(GeneratedApiEntity api,
                                    ...
                                    com.usg.apiGeneration.repositories.documentation.FolderRepository folderRepository,
        ...
        try {
            ...
            if (docCollectionId != null) {
                Optional<com.usg.apiGeneration.entities.postgres.documentation.APICollectionEntity> existingCollection =
    ...
    private void updateCodeBaseRequest(com.usg.apiGeneration.entities.postgres.codeBase.RequestEntity requestEntity,
                                       GeneratedApiEntity api,
                                       String performedBy,
                                       CollectionInfoDTO collectionInfo,
                                       CollectionRepository collectionRepository,
    ...
    private void updateCodeBaseCollection(com.usg.apiGeneration.entities.postgres.codeBase.RequestEntity requestEntity,
                                          CollectionInfoDTO collectionInfo,
                                          String performedBy,
                                          CollectionRepository collectionRepository,
                                          FolderRepository folderRepository,
                                          EntityManager entityManager) {
        try {
            Optional<com.usg.apiGeneration.entities.postgres.codeBase.CollectionEntity> existingCollection =
                    collectionRepository.findByIdWithLock(collectionInfo.getCollectionId());

            com.usg.apiGeneration.entities.postgres.codeBase.CollectionEntity collection;
            if (existingCollection.isPresent()) {
                ...
                collection = com.usg.apiGeneration.entities.postgres.codeBase.CollectionEntity.builder()
    ...
    private void updateCodeBaseFolder(com.usg.apiGeneration.entities.postgres.codeBase.RequestEntity requestEntity,
                                      CollectionInfoDTO collectionInfo,
                                      com.usg.apiGeneration.entities.postgres.codeBase.CollectionEntity collection,
                                      FolderRepository folderRepository,
                                      EntityManager entityManager) {
        Optional<com.usg.apiGeneration.entities.postgres.codeBase.FolderEntity> existingFolder =
                folderRepository.findByIdWithLock(collectionInfo.getFolderId());

        com.usg.apiGeneration.entities.postgres.codeBase.FolderEntity folder;
        if (existingFolder.isPresent()) {
            ...
            folder = com.usg.apiGeneration.entities.postgres.codeBase.FolderEntity.builder()
    ...
    private void updateCollectionEntity(com.usg.apiGeneration.entities.postgres.collections.CollectionEntity collection,
                                        GeneratedApiEntity api,
                                        CollectionInfoDTO collectionInfo,
                                        String performedBy,
                                        com.usg.apiGeneration.repositories.collections.FolderRepository folderRepository,
    ...
    private void updateCollectionFolder(com.usg.apiGeneration.entities.postgres.collections.CollectionEntity collection,
                                        CollectionInfoDTO collectionInfo,
                                        com.usg.apiGeneration.repositories.collections.FolderRepository folderRepository,
                                        EntityManager entityManager) {
        Optional<com.usg.apiGeneration.entities.postgres.collections.FolderEntity> existingFolder =
                folderRepository.findById(collectionInfo.getFolderId());

        if (existingFolder.isPresent()) {
            com.usg.apiGeneration.entities.postgres.collections.FolderEntity folder = existingFolder.get();
            folder.setName(collectionInfo.getFolderName());
            folder.setCollection(collection);
            folderRepository.save(folder);
        } else {
            com.usg.apiGeneration.entities.postgres.collections.FolderEntity newFolder =
                    new com.usg.apiGeneration.entities.postgres.collections.FolderEntity();
    ...
    private void updateDocumentationCollection(com.usg.apiGeneration.entities.postgres.documentation.APICollectionEntity collection,
                                               GeneratedApiEntity api,
                                               CollectionInfoDTO collectionInfo,
                                               String performedBy,
                                               com.usg.apiGeneration.repositories.documentation.FolderRepository folderRepository,
        ...
        // Update endpoint
        List<com.usg.apiGeneration.entities.postgres.documentation.APIEndpointEntity> endpoints =
                endpointRepository.findByCollectionId(collection.getId());
        if (!endpoints.isEmpty()) {
            com.usg.apiGeneration.entities.postgres.documentation.APIEndpointEntity endpoint = endpoints.get(0);
    ...
    private void updateDocumentationFolder(com.usg.apiGeneration.entities.postgres.documentation.APICollectionEntity collection,
                                           CollectionInfoDTO collectionInfo,
                                           String performedBy,
                                           com.usg.apiGeneration.repositories.documentation.FolderRepository folderRepository,
                                           EntityManager entityManager) {
        Optional<com.usg.apiGeneration.entities.postgres.documentation.FolderEntity> existingFolder =
                folderRepository.findById(collectionInfo.getFolderId());

        if (existingFolder.isPresent()) {
            com.usg.apiGeneration.entities.postgres.documentation.FolderEntity folder = existingFolder.get();
            folder.setName(collectionInfo.getFolderName());
            folder.setCollection(collection);
            folder.setUpdatedBy(performedBy);
            folderRepository.save(folder);
        } else {
            com.usg.apiGeneration.entities.postgres.documentation.FolderEntity newFolder =
                    new com.usg.apiGeneration.entities.postgres.documentation.FolderEntity();
            newFolder.setId(collectionInfo.getFolderId());
            newFolder.setName(collectionInfo.getFolderName());
            newFolder.setCollection(collection);
