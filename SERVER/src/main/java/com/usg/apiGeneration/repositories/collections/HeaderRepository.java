...
import com.usg.apiGeneration.dtos.collections.HeaderDTO;
import com.usg.apiGeneration.entities.postgres.collections.HeaderEntity;
...
public interface HeaderRepository extends JpaRepository<HeaderEntity, String> {
    ...
    @Query("SELECT new com.usg.apiGeneration.dtos.collections.HeaderDTO(" +
