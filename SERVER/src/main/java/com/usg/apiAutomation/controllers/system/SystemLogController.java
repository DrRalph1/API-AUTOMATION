...
import com.usg.apiAutomation.services.system.SystemLogService;
...
//@Tag(name = "SYSTEM LOGS", description = "Endpoints for managing and retrieving system logs")
    ...
    public ResponseEntity<?> getAllLogFiles(HttpServletRequest req) {
        ...
        try {
            ...
            if (logFiles.isEmpty()) {
                ...
                Map<String, Object> noContentResponse = createSuccessResponse(204, "No log files found in the system", null, requestId);
