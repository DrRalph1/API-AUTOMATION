...
import com.usg.apiAutomation.dtos.user.OtpVerificationRequestDTO;
...
import com.usg.apiAutomation.services.OtpService;
...
public class OtpController {
    ...
    public ResponseEntity<?> verifyOtp(
        ...
        try {
            ...
            Optional<AppUserDTO> userOptional = appUserRepository.getUserByUserId(request.getUserId());
    ...
    public ResponseEntity<?> sendOtp(
        ...
        try {
            ...
            AppUserEntity user = appUserRepository.findByUserIdIgnoreCase(userId)
