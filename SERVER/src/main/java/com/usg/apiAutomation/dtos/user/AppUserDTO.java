package com.usg.apiAutomation.dtos.user;
...
public class AppUserDTO {
    ...
    // Constructor for create operations (without system fields)
    public AppUserDTO(String userId, String username, String password, String fullName,
    ...
    public static AppUserDTO fromEntityForResponse(com.usg.apiAutomation.entities.AppUserEntity entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static AppUserDTO fromEntityForManagement(com.usg.apiAutomation.entities.AppUserEntity entity) {
        if (entity == null) {
            return null;
        }
    ...
    // Add this constructor to AppUserDTO
    public AppUserDTO(
            String userId,
            String username,
            String password,
