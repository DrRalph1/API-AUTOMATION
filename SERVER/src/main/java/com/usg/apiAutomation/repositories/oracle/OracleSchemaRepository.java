...
public class OracleSchemaRepository {
    ...
    // ============================================================
// NEW: USED BY / DEPENDENT OBJECTS METHODS
// ============================================================

    /**
     * Get all objects that depend on (use) the specified object
     * This shows which procedures, functions, packages, etc. reference this object
     */
    public List<Map<String, Object>> getUsedBy(String objectName, String objectType, String owner) {
        try {
            ...
            List<Map<String, Object>> dependencies = oracleJdbcTemplate.queryForList(
            ...
            List<Map<String, Object>> transformed = dependencies.stream().map(dep -> {
                ...
                // For procedures/functions, add a note about parameters
    ...
    /**
     * Get hierarchical dependencies - shows both what this object depends on
     * and what depends on it (complete dependency graph)
     */
    public Map<String, Object> getDependencyHierarchy(String objectName, String objectType, String owner) {
        ...
        try {
            ...
            List<Map<String, Object>> referencedBy = oracleJdbcTemplate.queryForList(
            ...
            List<Map<String, Object>> usedBy = oracleJdbcTemplate.queryForList(
            ...
            List<Map<String, Object>> transformedUsedBy = usedBy.stream().map(use -> {
                ...
                try {
                    ...
                    String status = oracleJdbcTemplate.queryForObject(
    ...
    public Map<String, Object> getUsedBySummary(String objectName, String objectType, String owner) {
        ...
        try {
            ...
            List<Map<String, Object>> typeSummary = oracleJdbcTemplate.queryForList(
                    sql, owner, objectName, objectType);
